...
**1. Scene**: 게임 월드인 씬을 시각적으로 편집하는 창

**2. Hierarchy**: 씬에 존재하는 모든 게임 오브젝트가 나열

**3. Inspector**: 선택한 오브젝트의 정보가 표시

**4. Console**: 로그나 에러가 표시

**5. Project**: 프로젝트에 사용될 asset들이 표시
(asset: 개발에 사용되는 모든 형태의 파일)

**6. Game**: 플레이어가 실제로 보게 될 화면
